...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "sims 4 genetics overhaul",
    "sims 4 recessive genes",
    "sims 4 dominant recessive genetics",
    "sims 4 grandparent genetics",
    "sims 4 inheritance mod",
    "sims 4 family tree mod",
    "sims 4 legacy mod",
    "sims 4 realistic babies mod",
    "sims 4 babies look like parents",
    "sims 4 CAS genetics mod",
    "sims 4 mods",
  ],
  authors: [{ name: "Fox", url: "https://foxmademods.com" }],
  creator: "Fox Made Mods",
  publisher: "Fox Made Mods",
  category: "The Sims 4 Mods",
